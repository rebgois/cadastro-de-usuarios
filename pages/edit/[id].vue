  ...
  >
    <div class="bg-white p-8 rounded-xl shadow-xl w-full max-w-md">
      ...
      <div class="mt-6 flex justify-between">
        <NuxtLink
          to="/"
          class="flex items-center bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded shadow-md"
        >
        ...
        <NuxtLink
          to="/users"
          class="flex items-center bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded shadow-md"
        >
